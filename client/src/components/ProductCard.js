  ...
  return (<>
        <div className="relative  flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md  hover:scale-105 transition-transform duration-300">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <a href="#" className="flex items-center justify-center rounded-md bg-[#e68d8d] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#dc6262] focus:outline-none focus:ring-4 focus:ring-blue-300">
